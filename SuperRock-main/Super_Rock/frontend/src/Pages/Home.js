        ...
        <Container >
            ...
            <Row className='mt-5'>
                ...
                <Col sm={12} lg={6}>
                    ...
                    <h1>Kenny</h1>
                    <h3>Chef</h3>
                    <p>Synonymous with breaking Michelin stars records, Kenny currently holds 17 Michelin stars. This makes him the current living chef with the most Michelin stars in the world.</p>
                    <p>In addition to being known for world-class Chinese cuisine, Kenny is the only chef on this list who has sent his food into space. In 2015, Kenny sent meals to astronauts orbiting Earth aboard the International Space Station, an accomplishment that Kenny said he viewed as conquering ‘ the final frontier (of cooking)’.</p>
                </Col>
